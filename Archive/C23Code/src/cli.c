...
"            H1(.style = \"color: #0f172a; font-size: 2rem; font-weight: 800; margin-bottom: 8px;\") {\n"
"                Text(\"Mizar + HTMX 4\");\n"
"            }\n"
"            P(.style = \"color: #475569; font-size: 1rem; line-height: 1.5; margin-bottom: 24px;\") {\n"
"                Text(\"C23 web application with server-rendered hypermedia.\");\n"
"            }\n"
"\n"
...
"            }\n"
"\n"
"            MzClickToEdit(.url = \"/api/profile/status\", .label = \"Status\", .value = \"Active\");\n"
"        }\n"
"    }\n"
"}\n"
"\n"
